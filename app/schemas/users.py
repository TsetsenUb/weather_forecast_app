...
class UserBase(BaseModel):
    ...
    address: str | None = Field(
        default=None, description="Название города", examples=["Москва", "Moscow"]
    )
...
class UserIn(UserBase):
    ...
    password: str = Field(
        ..., min_length=8, max_length=255, description="Пароль (минимум 8 символов)"
    )
...
class UserUpdate(UserBase):
    ...
    name: str | None = Field(
        default=None, min_length=3, max_length=50, description="Имя пользователя"
    )
